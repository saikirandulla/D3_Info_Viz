  ...
  draw: function(id, data, options) {
    ...
    function buildVisComponents() {
      ...
      vis.legend = vis.svg.append("svg:g").classed("legend", true)
        ...
        .attr("transform", "translate(" + 0.5 * config.w + ", " + 0.4 * config.h + ")");
    ...
    function buildLegend(data) {
      ...
      vis.legend.selectAll(".legend-tiles")
        ...
        // .on(over, function(d, g) {
        //   vis.svg.selectAll(".polygon-areas") // fade all other polygons out
        //   .transition(250)
        //     .attr("fill-opacity", 0.1)
        //     .attr("stroke-opacity", 0.1);
        //
        //   console.log(d3.selectAll(".polygon-areas")[0][g]);
        //   d3.selectAll(".polygon-areas")[0][g] // focus on active polygon
        //   // .transition(250)
        //     .attr("fill-opacity", 0.7)
        //     .attr("stroke-opacity", config.polygonStrokeOpacity);
        // })
      ...
      vis.legend.selectAll(".legend-labels")
        ...
        .attr("fill", "gray")
        .text(function(d) {
          return "Average for universities ranked " + d.group;
        });
    }
    ...
    function verticesTooltipShow(d) {
      vis.verticesTooltip.style("opacity", 0.9)
        .html("<strong>Category</strong>: " + d.axis + "<br />" + "<strong>Value</strong>: " + d.value + "<br />"
          )
